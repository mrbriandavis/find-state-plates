defmodule FindStatePlates.MixProject do
  use Mix.Project

  def project do
    [
      app: :find_state_plates,
      version: "0.1.0",
      elixir: "~> 1.17",
  ...
  def application do
    [
      mod: {FindStatePlates.Application, []},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind find_state_plates", "esbuild find_state_plates"],
      "assets.deploy": [
        "tailwind find_state_plates --minify",
        "esbuild find_state_plates --minify",
        "phx.digest"
      ]
    ]
  end
